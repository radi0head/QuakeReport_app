...
import java.util.ArrayList;
    ...
    public final class QueryUtils {
         ...
         */
        public static ArrayList<EarthquakeItemClass> extractEarthquakes() {

            // Create an empty ArrayList that we can start adding earthquakes to
            ArrayList<EarthquakeItemClass> earthquakes = new ArrayList<>();
            ...
            try {
                ...
                for(int i=0;i<earthquakeDetails.length();i++){
                    ...
                    earthquakes.add(new EarthquakeItemClass(earthquakeProperties.getDouble("mag"),earthquakeProperties.getString("place"),earthquakeProperties.getLong("time")));
                }
